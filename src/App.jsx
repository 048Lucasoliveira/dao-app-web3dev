...
const App = () => {
  ...
  //contrato 0x0eFc68Ad081e85412AEAC42E7B6BFa5ecBB8a45e
  const { contract: token } = useContract('0x0eFc68Ad081e85412AEAC42E7B6BFa5ecBB8a45e', 'token');
  //dask para fazer votaçao na pagina
  const { contract: vote } = useContract("0x44432373457a2f4dbb92E933509276C249E77Ef4", "vote");
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Bem-vindos à InvestDAO - a DAO dos Investidores</h1>
...
if (hasClaimedNFT) {
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe seu NFT ele mostra que você é membro da InvestDAO</h1>
      <div className="btn-hero">
        <Web3Button 
